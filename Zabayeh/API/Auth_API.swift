...
//                      self.defaults.set(true, forKey: "is_login")
    ...
    func updateProfile(name:String,password:String,mobile:String,completion : @escaping(_ code: Int) -> () ){
              
              let parameters : [String : Any] = [
                  "mobile":mobile,
                  "user_id":defaults.integer(forKey: "id"),
                  "name":name,
                  "password":password,
              ]
              
              Alamofire.request(updateProfileURL, method: .post, parameters: parameters, encoding:URLEncoding.default , headers: nil).validate(statusCode: 200..<300).responseJSON { (response) in
